      ...
      <div class="col-md-12 col-lg-4 mb-5 mt-lg-0">
        <div class="redes">
          <a
            ...
            class="mt-10"
            :href="red.item"
            target="_blanck"><font-awesome-icon :icon="['fab', red.icon]" />
          </a>
        </div>
      </div>
    </div>
        ...
        url: [
          {
            ...
            item: "https://api.whatsapp.com/send?phone=543624276033"
          },
          {
            icon: "github-square",
            item: "https://github.com/LacunzaSandro"
          },
          {
            icon: "linkedin",
            item: "https://www.linkedin.com/in/sandro-lacunza/"
          },
        ],
      }
    },
